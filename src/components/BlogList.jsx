	...
	return (
		<>
			...
			<div className='flex justify-between items-center'>
				...
				<h1 className='text-sm font-medium text-gray-300 dark:text-gray-500'>
			...
			{!filteredPosts.length && (
				<h1 className='text-lg font-bold underline decoration-wavy decoration-2 decoration-sky-500 underline-offset-2'>
					None Found.
				</h1>
			)}
